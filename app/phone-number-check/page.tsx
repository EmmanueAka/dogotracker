...
import Vault from "@/app/email-check/vault"
import PhoneScanner from "@/app/phone-number-check/phone-scanner";
            ...
            <div className='email-check z-30'>
                ...
                <div className='col-span-2 w-full h-full z-50'>
                    <div className='flex-1 p-6'>
                        ...
                        {activePage === "scanner" && <PhoneScanner onScanComplete={fetchRecentScans} />}
