                    ...
                    <div className='relative h-auto w-[650px] border border-[#00f2ff]/20 z-10 rounded-md bg-gray-800 px-6 py-6 mb-8'>
                        ...
                        <div className='flex items-center justify-center gap-4'>
                            ...
                            <div className='flex items-center justify-center gap-4'>
                                ...
                                <button
                                    className={`flex items-center justify-center p-4 w-[52px] rounded-md font-bold ${ loading ? "bg-black text-gray-500 cursor-not-allowed" : "bg-gray-700 text-white hover:bg-gray-600"}`}
                                    onClick={handleReset}
                                    disabled={loading}
                                >
                        ...
                        {results && (
                            <div className='w-full mt-8 mb-8 text-white border-t border-gray-700/50 pt-6 animate-fade-in'>

                                {/* 🟢 NEW: High-Heuristic Identity Profile Card Component Render */}
                                <h3 className='primary-text font-bold text-xl mb-3 text-[#00f2ff]'>👤 IDENTIFIED PROFILE NODE</h3>
                                <div className='bg-gradient-to-r from-gray-900 to-black border border-[#00f2ff]/30 p-6 rounded-lg mb-6 font-mono text-sm space-y-3 shadow-lg'>
                                    <p className="text-lg">
